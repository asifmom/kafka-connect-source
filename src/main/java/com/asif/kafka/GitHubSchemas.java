...
public class GitHubSchemas {
    ...
    // Schema names
    public static final String SCHEMA_KEY = "com.asif.kafka.connect.github.IssueKey";
    public static final String SCHEMA_VALUE_ISSUE = "com.asif.kafka.connect.github.IssueValue";
    public static final String SCHEMA_VALUE_USER = "com.asif.kafka.connect.github.UserValue";
    public static final String SCHEMA_VALUE_PR = "com.asif.kafka.connect.github.PrValue";
